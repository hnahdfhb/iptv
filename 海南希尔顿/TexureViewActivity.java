...
//        SPUtils.put(this, Constants.PAY_CHOOSE, Constants.ONLINE_PAY);
        ...
        //获取视频url  //------lastCacheUrl这个应该获取是开机视屏
...
//        删除本地已经有的APK
    ...
    protected void onResume() {
        ...
        try {
                if (mediaPlayerState == 2 && isMainFragmentUI) {
                    playVideo();
...
//                        startActivity(intent);
    ...
    public void onGuideClick() {
       ...
       /* if (mediaPlayer != null) {
        ...
        try {
            ...
            String startingVideo = Constants.mainPageInfo.getStartingVideo();
    ...
    public void onSuccess(BaseModel<List<MainPageInfo>> dataList) {
        ...
        if (mainPageInfos != null && mainPageInfos.size() != 0 && mainPageInfos.get(0) != null) {
            ...
            ShowImageUtils.showImageView(this, Constants.mainPageInfo.getFileUpload().getPath(), iv_bg);
